  ...
  <body onload="htmlTableOfContents();">
    ...
    <div class="maincontent">
        ...
        <section class="container theme-showcase" role="main" style="height:80%">
            <!-- <h3>About</h3> -->
            My name is Steve Göring, I'm a computer scientist and researcher.
            ...
            <ul>
                <li><a href="http://stg7.github.io/phrasit/" target="_blank">PhrasIt</a> -- an experimenal ngram search engine</li>
                <li><a href="http://github.com/stg7/ctag/" target="_blank">Ctag</a> -- a generator for cloud tags</li>
                <!--
                <li><a href="http://stg7.bplaced.net/" target="_blank">my Homepage</a></li>-->
                <li><a href="https://bitbucket.org/stg7/" target="_blank">bitbucket</a> -- my bitbacket page</li>
